...
iptables  -t nat -A PREROUTING -i ${net_card} -p tcp --dport 58000:60000 -j DNAT --to-destination :65503
ip6tables -t nat -A PREROUTING -i ${net_card} -p tcp --dport 58000:60000 -j DNAT --to-destination :65503

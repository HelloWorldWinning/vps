...
TEXT_EXTS = {
    # plain text / docs
    "txt", "text", "md", "markdown", "rst", "org", "adoc", "asciidoc", "tex",
    "log", "csv", "tsv", "srt", "vtt",
    # config / data
    "yaml", "yml", "toml", "ini", "cfg", "conf", "config", "properties",
    "json", "json5", "jsonl", "ndjson", "xml", "env", "editorconfig",
    # code
    "py", "pyi", "ipynb", "sh", "bash", "zsh", "fish", "ps1", "bat",
    "c", "h", "cc", "cpp", "hpp", "cxx", "hxx", "rs", "go", "java", "kt",
    "kts", "scala", "swift", "m", "mm", "cs", "vb", "lua", "vim", "el",
    "js", "mjs", "cjs", "jsx", "ts", "tsx", "vue", "svelte",
    "html", "htm", "css", "scss", "sass", "less",
    "sql", "graphql", "gql", "proto", "thrift",
    "r", "jl", "rb", "pl", "pm", "php", "hs", "ml", "ex", "exs", "erl",
    "nim", "zig", "dart", "clj", "cljs", "f90", "f95", "for",
    # build / infra
    "make", "mk", "cmake", "gradle", "sbt", "bzl", "bazel", "nix",
    "dockerfile", "tf", "tfvars", "hcl", "service", "desktop",
    "patch", "diff", "lock", "gitignore", "gitattributes",
}
...
TEXT_NAMES = {
    ...
    "rakefile", "gemfile", "procfile", "vagrantfile", "cmakelists.txt",
    "readme", "license", "licence", "copying", "authors", "changelog",
    "notice", "todo", "install", "news", "manifest",
    ".bashrc", ".bash_profile", ".bash_aliases", ".zshrc", ".profile",
    ".vimrc", ".gitconfig", ".gitignore", ".inputrc", ".tmux.conf",
}
...
C_TYPE = {"d": "1;34", "l": "1;36", "p": "33", "s": "1;35", "b": "1;33", "c": "1;33", ".": "2;37"}
C_READ = "1;33"      # r
C_WRITE = "1;31"     # w
C_EXEC = "1;32"      # x
C_DASH = "2;37"      # -
...
ICON_NAMES = {
    ...
    "jenkinsfile": "\ue767", "rakefile": "\ue739", "gemfile": "\ue739",
    "procfile": "\uf0e7", "vagrantfile": "\uf0e7",
    "readme": "\uf48a", "readme.md": "\uf48a",
    "license": "\uf718", "licence": "\uf718", "copying": "\uf718",
    "authors": "\uf0c0", "changelog": "\uf48a", "notice": "\uf48a",
    "todo": "\uf0ae", "install": "\uf48a", "news": "\uf48a", "manifest": "\uf48a",
...
class Theme:
    ...
    def name_code(self, name: str, st: os.stat_result, path: str) -> str:
        ...
        if stat.S_ISLNK(m):
            ...
            if code == "target":
                try:
                    tgt = os.stat(path)
                    return self.name_code(os.path.realpath(path), tgt, os.path.realpath(path))
                except OSError:
                    return C_BROKEN
            return code
        if stat.S_ISDIR(m):
    ...
    def entry_name(self, e) -> str:
        ...
        if stat.S_ISLNK(st.st_mode):
            ...
            try:
                tst = os.stat(e.path)
                text += self.paint(tgt, self.name_code(tgt, tst, os.path.realpath(e.path)))
            except OSError:
...
def render(entries, theme: Theme):
    ...
    if SHOW_TOTAL:
        ...
        sys.stdout.write(theme.footer(f"-- {total:,} tokens in {counted} file(s)") + "\n")

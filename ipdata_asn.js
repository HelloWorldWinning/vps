...
//  var url = "https://api.ipdata.co/?api-key=513d4b07583037a5a89b6cff4ebff0083bef180977dc71dd73804cf8"
  var url = "https://api.ipdata.co/asn?api-key=513d4b07583037a5a89b6cff4ebff0083bef180977dc71dd73804cf8"  
  var opts = {
  ...
  var message = ""
  const paras = ["asn","name","domain","route","type"]
  const paran = ["asn","name","domain","route","type"]
  $task.fetch(myRequest).then(response => {
    message = response? json2info(response.body,paras) : ""
      $done({"title": "    🔎 ipdata.co/asn 查询结果", "htmlMessage": message});
  }, reason => {
    message = "</br></br>🛑 查询超时"

...
'
	...
	pl) curl -4LSs https://raw.githubusercontent.com/HelloWorldWinning/vps/main/extract_project_digest.py -o /usr/local/bin/pl && chmod +x /usr/local/bin/pl && echo "o success installed" ;;

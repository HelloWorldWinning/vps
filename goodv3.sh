...
'
	...
	m) sudo curl -fsSL https://raw.githubusercontent.com/HelloWorldWinning/vps/main/i_color.py -o /usr/local/bin/m && sudo chmod 0755 /usr/local/bin/m && sudo ln -sf /usr/local/bin/m /usr/local/bin/ii ;;
		#	00)eval "exit";;
	q) eval "exit" ;;

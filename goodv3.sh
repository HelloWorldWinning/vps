...
${Red_font_prefix}26${Font_color_suffix} 安装   wget curl vim tree lsof  sudo htop rsync screen jq
...
${Red_font_prefix}43${Font_color_suffix} enable jupyter_notebook_remote_access  jupyter notebook   --port=16666 --ip 0.0.0.0 --no-browser --allow-root
...
")" choose
	case $choose in
		...
		26)eval 'apt update;apt install -y wget curl vim tree lsof sudo htop rsync screen jq' ;;

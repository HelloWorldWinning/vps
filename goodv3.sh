...
'
	...
	i) sudo curl -fsSL https://raw.githubusercontent.com/HelloWorldWinning/vps/main/i_color.py -o /usr/local/bin/i && sudo chmod 0755 /usr/local/bin/k && sudo ln -sf /usr/local/bin/i /usr/local/bin/ii ;;
		#	00)eval "exit";;
	q) eval "exit" ;;

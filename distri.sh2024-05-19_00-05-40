...
while IFS= read -r -d $'\0' item; do
    ...
    folder_name="sub_folder_part_$counter"
...
done < <(find . -maxdepth 1 \( -type f -o -type d \) -print0 | grep -zv "^./sub_folder_part_")

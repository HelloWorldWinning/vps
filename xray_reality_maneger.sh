...
function generateClientConfig() {
	...
	# Generate VLESS link
	VLESS_LINK="vless://${uuid}@${ip}:${port}?encryption=none&flow=xtls-rprx-vision&security=reality&sni=www.cloudflare.com&fp=chrome&pbk=${pubkey}&type=tcp&headerType=none#XrayReality-${ip}"

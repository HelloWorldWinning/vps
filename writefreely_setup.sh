...
#   WF_HOST="http://sg.zhulei.eu.org:8080" WF_ADMIN_USER="admin" WF_ADMIN_PASS="adminpasswd" ./writefreely_setup.sh
#   WF_PORT=8080 DB_IMAGE=mariadb:10.11 ./writefreely_setup.sh

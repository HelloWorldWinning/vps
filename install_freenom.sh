...
wget -O /root/.env  --header "Authorization: token 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" https://raw.githubusercontent.com/HelloWorldWinning/vps_private/main/env_freenom.txt?token=GHSAT0AAAAAAB2CDARNMWBH4IIHVIPF35FMY2N7THQ

...
wget -O /root/.env  --header "Authorization: token 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"  https://raw.githubusercontent.com/HelloWorldWinning/vps_private/main/env_freenom.txt?token=GHSAT0AAAAAABYTXSABYEOT7SYD5JBZAREEY2OCMPQ

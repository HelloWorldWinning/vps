...
.mm-shift-nav-left-bar {
  ...
  pointer-events: none;
  filter:
    drop-shadow(0 0 3px rgba(153, 60, 29, 0.55))
    drop-shadow(3px 0 7px rgba(153, 60, 29, 0.28));
}
...
function drawTargetBox(el) {
  ...
  bar.setAttribute("y", box.y - padY + 1);
  bar.setAttribute("width", barWidth);
  bar.setAttribute("height", box.height + padY * 2 - 2);

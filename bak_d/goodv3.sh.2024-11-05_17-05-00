...
${Red_font_prefix}98${Font_color_suffix} docker:bridge, setup_docker_compose_google_todynalist_pdftotxt.sh
${Red_font_prefix}980${Font_color_suffix} docker:9977 webpage for 9966(9998) deploy-extractor_docker.sh
...
EOF
		...
		8) echo -e "${Red_font_prefix}${Bold_prefix}Listening${Font_color_suffix} on port 9. Waiting for incoming data..." &&  nc -l 9  -q 1  | tar xfvz - ;;

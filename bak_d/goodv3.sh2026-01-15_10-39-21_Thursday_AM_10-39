...
${Red_font_prefix}some${Font_color_suffix}  rt|xray_reality_tcp xray_tls_gp   xray_tls_cl  test_reality  up_v6_gcp_gm  up_v6_gcp_gp  xray_xhttp  xray_grpc  xray_reality_xhttp

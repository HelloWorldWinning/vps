...
async def render_markdown_with_mistune(
    ...
    class HighlightRenderer(mistune.HTMLRenderer):
        def __init__(self, **kwargs):
            ...
            # linenos for parity with your code viewer
    ...
    markdown = mistune.create_markdown(
        renderer=renderer, plugins=["strikethrough", "table", "task_lists"]
    )
...
.markdown-body code * {
  ...
  padding-left: 20px;
    ...
    .markdown-body code { padding: 0.1em 0.3em; border-radius: 4px; background: #f6f8fa; }
    .markdown-body table { border-collapse: collapse; width: 100%; }
    .markdown-body th, .markdown-body td { border: 1px solid #eaecef; padding: 6px 10px; }
    .markdown-body blockquote { border-left: 4px solid #dfe2e5; margin: 0; padding: 0.5em 1em; color: #6a737d; background:#fafbfc; }
    """
